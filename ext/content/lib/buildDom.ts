...
import { createBlankSpan, templates } from '../../lib/templates'
...
/**
 * Recursively builds a DOM tree of nested spans with classnames, based on a JSON value (or key-value pair).
 *
